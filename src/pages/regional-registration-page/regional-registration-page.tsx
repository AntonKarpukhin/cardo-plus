...
import {
    Button,
    HeaderAuthorization, Input, Paragraph, InputDate, LayoutMain,
} from '../../components';
import { useProfileStore } from '../../store/profile-slice';
import { useTypesOfCompetitionsStore } from '../../store/types-of-competitions';
    ...
    return (
        <LayoutMain>
            <section className={styles.ApplicationRegistrationPage}>
                ...
                <Button color="red" type="button" text="Подать заявку" onClick={() => navigate('/profile')} />
            </section>
        </LayoutMain>
    );
};
